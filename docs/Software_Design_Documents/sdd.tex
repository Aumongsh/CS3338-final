...
\begin{tabularx}{\textwidth}{|c|c|c|X|}
    ...
    \hline
    Kadence Tang & 2.0 & 5 Dec 2025 & Checkpoint 2: Updated user interface information. \\
    \hline
    Kadence Tang & 3.0 & 7 Dec 2025 & Checkpoint 3: Cleaned up formatting. \\
    \hline
    Kadence Tang & 4.0 & 9 Dec 2025 & Final Draft. Made some corrections. \\
    \hline 
\end{tabularx}
\newpage
...
\section{System Architecture}
    ...
    \begin{itemize}
        ...
        \item \textbf{Data Collection and Aggregation:} Collect and aggregate usernames to build a dataset for analysis.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Results Module:} Displays the number of overlapping viewers and the percentage of overlapping viewers between the two input channels.
